  ...
  const handleSubmit = (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-(--color-background) p-4">
            <div className="w-full max-w-md bg-component-background rounded-lg shadow-xl p-8 border border-gray-700/50">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-white">로그인</h1>
                    <p className="text-gray-400 mt-2">계정에 접속하여 팀원을 찾아보세요</p>
                </div>
                        ...
                        <div className="flex items-center">
                            <div className="relative inline-flex items-center">
                                <input 
                                    id="remember" 
                                    type="checkbox" 
                                    className="appearance-none h-5 w-5 border border-gray-600 rounded bg-gray-800/50 checked:bg-purple-600 checked:border-purple-600 focus:outline-none focus:ring-1 focus:ring-purple-500 focus:ring-offset-1 focus:ring-offset-gray-800 transition-colors duration-200 cursor-pointer peer"
                                />
                                <svg 
                ...
                <div className="mt-8">
                    ...
                    <div className="mt-6 space-y-3">
                        <button
                            type="button"
                            className="w-full inline-flex justify-center items-center py-2.5 px-4 border border-gray-600/50 rounded-md bg-gray-800/50 hover:bg-gray-800/60 text-sm font-medium text-white transition duration-200"
                        >
                ...
                <div className="mt-6 text-center text-sm">
                    <p className="text-gray-400">
                        계정이 없으신가요? 
                        <Link href="/signup" className="text-purple-400 hover:text-purple-300 ml-1">회원가입</Link>
                    </p>
                </div>
            </div>
        </div>
