            ...
            >
              <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-xl bg-gray-800 p-0 text-left align-middle shadow-xl transition-all border border-gray-700 flex flex-col max-h-[90vh]">
                ...
                <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-7">
                  ...
                  <div className="pt-5 border-t border-gray-700 flex justify-end space-x-3 mt-6">
                    <button
                      type="button"
                      onClick={onClose}
                      className="px-5 py-2.5 rounded-lg bg-gray-700 text-gray-300 hover:bg-gray-600 transition-all duration-150 focus:ring-2 focus:ring-gray-500 focus:ring-offset-1 focus:ring-offset-gray-800"
                    >
                      취소
                    </button>
                    <button
                      type="submit"
                      className="px-6 py-2.5 rounded-lg bg-purple-600 text-white font-medium hover:bg-purple-500 transition-all duration-150 shadow-lg shadow-purple-600/20 focus:ring-2 focus:ring-purple-500 focus:ring-offset-1 focus:ring-offset-gray-800"
                    >
                      작업 생성
                    </button>
                  </div>
