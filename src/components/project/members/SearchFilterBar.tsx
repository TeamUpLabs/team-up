        ...
        <div className="relative w-full">
          ...
          <input
            ...
            className="pl-10 pr-4 py-2.5 w-full bg-project-page-title-background text-text-secondary rounded-lg
                      border border-component-border hover:border-point-color-indigo-hover focus:border-point-color-indigo-hover focus:ring-1 focus:ring-point-color-purple-hover/20 
