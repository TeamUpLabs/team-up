            ...
            {taskData?.subtasks?.length > 0 ? (
              taskData?.subtasks?.map((subtask, index) =>
                isEditing === "subtasks" ? (
                  <div
                    key={index}
                    className="flex items-center gap-2 bg-component-secondary-background border border-component-border p-3 rounded-lg"
                  >
                    <input
                      type="checkbox"
          ...
          <div className="space-y-4">
            {taskData?.comments && taskData?.comments.length > 0 ? (
              taskData?.comments?.map((comment, index) => (
                <div
                  key={index}
                  className="bg-component-secondary-background p-4 rounded-lg border border-component-border hover:border-component-border-hover transition-all duration-200 shadow-sm"
                >
