      ...
      <div className="mb-6 flex flex-col md:flex-row gap-4 md:items-center md:space-x-3">
        <div className="relative flex-1">
          <input
            ...
            className="w-full bg-input-background border border-input-border rounded-lg pl-10 pr-4 py-2.5 text-text-secondary placeholder-text-secondary hover:border-input-border-hover focus:border-point-color-indigo focus:outline-none transition-colors"
          />
