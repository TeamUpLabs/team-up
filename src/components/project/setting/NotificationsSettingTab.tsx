export default function NotificationsSettingTab() {
  return (
    <div className="bg-component-background backdrop-blur-sm rounded-xl overflow-hidden shadow-lg border border-component-border">
      ...
      <div className="p-6 space-y-5">
        <div className="flex items-center justify-between p-4 bg-component-secondary-background rounded-lg border border-component-border transition-all hover:border-component-border-hover">
          ...
          <label className="relative inline-flex items-center cursor-pointer">
            ...
            <div className="w-11 h-6 bg-component-background rounded-full peer peer-focus:ring-2 peer-focus:ring-point-color-indigo peer-checked:bg-point-color-indigo peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
          </label>
        </div>
