    ...
    <ProjectProvider project={project}>
      <VoiceCallProvider>
        <div className="flex min-h-screen bg-background">
          ...
          >
            <header
              className={`h-auto bg-component-background min-h-16 border-b border-component-border backdrop-blur-sm fixed top-0 right-0 left-0 ${
                isMinimized ? "lg:left-16" : "lg:left-64"
              } ${
