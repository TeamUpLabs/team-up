  ...
  return (
    <div className="p-6 border border-red-500 rounded-lg bg-red-500/10">
      ...
      <div className="mt-6 space-y-6">
        <div>
          <h3 className="text-lg font-medium text-gray-200">프로젝트 보관</h3>
          <p className="text-gray-400 text-sm mb-3">프로젝트를 보관처리하면 접근은 가능하지만 더 이상 수정할 수 없습니다.</p>
        ...
        <div className="pt-6 border-t border-gray-700">
          <h3 className="text-lg font-medium text-gray-200">프로젝트 삭제</h3>
