...
import { faHome, faMessage, faTasks, faCalendar, faUsers, faFlag, faGear, faChevronLeft } from "@fortawesome/free-solid-svg-icons";
...
export default function ProjectLayout({
  ...
  const projectNavItems = [
    { icon: faHome, label: "대시보드", href: `/platform/${projectId}`, isActive: pathname === `/platform/${projectId}` },
